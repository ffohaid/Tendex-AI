...
/// <summary>
/// Validates the GenerateSectionDraftCommand before processing.
/// </summary>
public sealed class GenerateSectionDraftCommandValidator
    : AbstractValidator<GenerateSectionDraftCommand>
{
    public GenerateSectionDraftCommandValidator()
    {
        ...
        RuleFor(x => x.SectionType)
            .NotEmpty()
            .MaximumLength(100)
            .WithMessage("SectionType is required and must not exceed 100 characters.");
