...
namespace TendexAI.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260506205311_PendingModelChanges")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TendexAI.Domain.Entities.ActiveDirectoryConfiguration", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.Property<string>("GroupAttributeMapping")
                        .HasMaxLength(4000)
                    ...
                    b.Property<string>("LastConnectionTestError")
                        .HasMaxLength(2000)
                    ...
                    b.ToTable("ActiveDirectoryConfigurations", (string)null);
                });
            ...
            modelBuilder.Entity("TendexAI.Domain.Entities.Identity.PermissionMatrixRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int?>("CompetitionPhase")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RoleId", "Scope", "ResourceType", "IsActive")
                        .HasDatabaseName("IX_PermissionMatrixRules_Lookup");

                    b.HasIndex("TenantId", "RoleId", "Scope", "ResourceType", "CommitteeRole", "CompetitionPhase")
                        .IsUnique()
                        .HasDatabaseName("IX_PermissionMatrixRules_Dimensions")
                        .HasFilter("[CommitteeRole] IS NOT NULL AND [CompetitionPhase] IS NOT NULL");

                    b.ToTable("PermissionMatrixRules", "identity");
                });
            ...
            modelBuilder.Entity("TendexAI.Domain.Entities.Rfp.Competition", b =>
                {
                    ...
                    b.Property<DateTime?>("InquiriesStartDate")
                        .HasColumnType("datetime2");

                    b.Property<int?>("InquiryPeriodDays")
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("OffersStartDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("RequiredAttachmentTypesSerialized")
                        .HasColumnType("nvarchar(max)")
            ...
            modelBuilder.Entity("TendexAI.Domain.Entities.SupportTicket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int?>("AiSuggestedCategory")
                        .HasColumnType("int");

                    b.Property<int?>("AiSuggestedPriority")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TendexAI.Domain.Entities.SupportTicketMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TendexAI.Domain.Entities.ActiveDirectoryConfiguration", b =>
                {
                    b.HasOne("TendexAI.Domain.Entities.Tenant", "Tenant")
                        .WithOne()
                        .HasForeignKey("TendexAI.Domain.Entities.ActiveDirectoryConfiguration", "TenantId")
            ...
            modelBuilder.Entity("TendexAI.Domain.Entities.SupportTicketMessage", b =>
                {
                    b.HasOne("TendexAI.Domain.Entities.SupportTicket", "SupportTicket")
                        .WithMany("Messages")
