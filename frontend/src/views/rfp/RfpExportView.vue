 ...
 * RFP Export View.
 *
 * Issue 22 Fix: Provides a print-ready view of the RFP booklet
 * that can be exported as PDF using the browser's print functionality.
 * This view loads the full competition data and renders it in a
 * structured, professional format suitable for printing.
 */
...
<template>
  <div class="min-h-screen bg-surface-ground">
    ...
    <!-- Error -->
    <div v-else-if="error" class="mx-auto max-w-4xl px-4 py-20 text-center">
      <i class="pi pi-exclamation-triangle text-4xl text-danger"></i>
      <p class="mt-3 text-sm text-danger">{{ error }}</p>
    </div>

    <!-- Booklet Content (print-ready) -->
    <div v-else-if="rfpData" class="mx-auto max-w-4xl px-4 py-8 print:px-0 print:py-0">
      <div class="rounded-lg border border-surface-dim bg-white p-8 shadow-sm print:border-0 print:shadow-none">
        ...
        <div class="mb-8">
          ...
          <div class="text-sm leading-relaxed text-secondary whitespace-pre-wrap">
        ...
        <div v-if="rfpData.content.sections.length > 0" class="mb-8">
          ...
          >
            ...
            <div
              ...
              class="text-sm leading-relaxed text-secondary whitespace-pre-wrap"
            >
              {{ section.content }}
            </div>
