...
function getTypeName(type: string): string {
  const map: Record<string, string> = {
    ...
    approval: t('approvals.types.approval'),
    approve_request: t('approvals.types.approveRequest'),
    evaluate_offer: t('approvals.types.evaluateOffer'),
    answer_inquiry: t('approvals.types.answerInquiry'),
    committee_action: t('approvals.types.committeeAction'),
    approve_inquiry_response: t('approvals.types.approveInquiryResponse'),
  }
...
function getActionRequiredLabel(actionRequired: string): string {
  const map: Record<string, string> = {
    review_and_approve: t('approvals.actionRequired.reviewAndApprove'),
    waiting_for_prior_step: t('approvals.actionRequired.waitingForPriorStep'),
    evaluate_technical_offers: t('approvals.actionRequired.evaluateTechnicalOffers'),
    evaluate_financial_offers: t('approvals.actionRequired.evaluateFinancialOffers'),
    review_award_recommendation: t('approvals.actionRequired.reviewAwardRecommendation'),
    respond_to_inquiries: t('approvals.actionRequired.respondToInquiries'),
    review_contract: t('approvals.actionRequired.reviewContract'),
    review: t('approvals.actionRequired.review'),
    respond_to_inquiry: t('approvals.actionRequired.respondToInquiry'),
    approve_inquiry_response: t('approvals.actionRequired.approveInquiryResponse'),
  }
  return map[actionRequired] || actionRequired
}
        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          ...
          <div class="flex items-center gap-2">
            <span class="text-xs text-tertiary">
              {{ getActionRequiredLabel(task.actionRequired) }}
            </span>
            <button
